// Wrapped for GJS ES module consumption: the IIFE below is upstream
// tweetnacl-js unmodified, invoked against a plain object captured here
// instead of `module.exports`/`self.nacl` (neither exists in GJS).
const naclExports = {};
(function(nacl) {
'use strict';
