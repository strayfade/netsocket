...
NodeDefinition.prototype.description = "Sends an HTTP GET request with optional JSON headers, timeout, and retries. Routes to Success or Failed and outputs the response body and status code."
NodeDefinition.prototype.color = "blue"
NodeDefinition.prototype.icon = "downloading"

const NodeFunction = async (node, params, behaviors) => {
    try {
        const result = await performWebRequest('GET', params.URL, {
        ...
        log(`GET request failed: ${error.message}`, logColors.Error)
