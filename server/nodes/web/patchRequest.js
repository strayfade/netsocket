...
NodeDefinition.prototype.title = "Web/PATCH Request"
NodeDefinition.prototype.description = "Sends an HTTP PATCH request with a configurable body and content type, outputting the response body and status code."
NodeDefinition.prototype.portMeta = {
	inputs: {
		...
		"Content Type": {"description":"Input \"Content Type\" for PATCH Request.","structure":"Text response body (often JSON serialized as a string).","required":true},
	},
	outputs: {
...
NodeDefinition.prototype.icon = "sync"

const NodeFunction = async (node, params, behaviors) => {
    try {
        const result = await performWebRequest('PATCH', params.URL, {
            body: params.Body,
        ...
        log(`PATCH request failed: ${error.message}`, logColors.Error)
