...
NodeDefinition.prototype.description = "Extracts the milliseconds component (0–999) from a timestamp in local time."
NodeDefinition.prototype.portMeta = {
	...
	outputs: {
		"": {"description":"Primary output of Get Milliseconds.","structure":"Numeric value (integer or float).","mcpKey":"output_0"},
	},
}
