...
NodeDefinition.prototype.description = "Extracts the four-digit year from a timestamp in UTC."
NodeDefinition.prototype.portMeta = {
	...
	outputs: {
		"": {"description":"Primary output of Get UTC Year.","structure":"Numeric value (integer or float).","mcpKey":"output_0"},
	},
}
